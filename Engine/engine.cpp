...
Engine::engine::engine(const char* win_name, int width, int height, int flag, int fps)
    :t(fps), event(), width(width), height(height)
{
    ...
    SDL_SetRenderLogicalPresentation(renderer, 1024, 720, SDL_LOGICAL_PRESENTATION_LETTERBOX);
